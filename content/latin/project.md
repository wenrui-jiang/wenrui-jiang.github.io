+++
title = "Proiecta"
description = "Proiecta et opus technicum"
date = "2025-05-19"
author = "Jiang Wenrui"
+++

## Integratio Agentis triagii in platforma informationis medicae

- **Tempus:** 2026.06 - 2026.07
- **Munus:** Backend / Applicatio Agent
- **Technologiae:** Java, Spring Boot, Spring Cloud, OpenFeign, DeepSeek API, Function Calling / Tool Calling, Agent Workflow, Session State, Human-in-the-loop, Redis, MySQL, MongoDB, JWT, Nginx, Docker
...
**Nexus proiecti:** [https://medical.jiangwenrui.com/](https://medical.jiangwenrui.com/)
